...
/// App Store / Google Play badges for Better Today dark surfaces.
class StoreButtons extends StatelessComponent {
  ...
  Component build(BuildContext context) {
    return div(classes: 'store-buttons${alignStart ? ' align-start' : ''}', [
      _badge(betterAppStoreUrl, 'Download on the', 'App Store'),
      _badge(betterPlayStoreUrl, 'Get it on', 'Google Play'),
    ]);
  }
