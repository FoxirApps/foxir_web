...
const betterPrivacy = LegalDocument(
  title: 'Privacy Policy for Better Today Mobile App',
  ...
  sections: [
    LegalSection(
      ...
      blocks: [
        LegalParagraph(
          'This Privacy Policy explains how Better Today Mobile App (“we,” “us,” or “our”) '
          'collects, uses, maintains, and discloses information from users (“User” or “you”) '
          'of the Better Today mobile application (“App”) and the website at '
          'https://foxirapps.co/bettertoday (“Website”).',
        ),
      ],
    ),
    LegalSection(
      ...
      blocks: [
        ...
        LegalTerm(
          ...
          'data (processed via App Store, Google Play, or RevenueCat), daily improvement '
          'entries and reflections, and authentication IDs (like Firebase UID, Apple ID, '
          'or Google ID). This information is provided directly by you during registration, '
          'purchases, or while using App features.',
        ),
        LegalTerm(
    ...
    LegalSection(
      ...
      blocks: [
        ...
        LegalTerm(
          'Core Functionality',
          'Personal data is used to track your daily improvement journey, display your '
          'progress calendar, maintain your streak counts, and sync data across your '
          'devices to support your long-term growth.',
        ),
        LegalTerm(
          'Account and Subscription Management',
          'Personal data is used to process payments, verify subscription entitlements, '
          'and restore purchases for premium features.',
        ),
        LegalTerm(
          'Personalization and Growth Insights',
          'Both personal and non-personal data are used to provide personalized daily '
          'prompts, suggest improvement areas, and offer motivational content inspired '
          'by the Mamba Mentality philosophy.',
        ),
        LegalTerm(
          'App Improvement and Analytics',
          'Non-personal data is used for crash reporting and analyzing feature usage '
          'trends to improve the App’s ability to support your daily improvement journey.',
        ),
        LegalTerm(
          'Communications',
    ...
    LegalSection(
      ...
      blocks: [
        ...
        LegalTerm(
          'Service Providers',
          'We share data with trusted processors necessary to operate Better Today, '
          'such as Firebase for hosting and authentication, RevenueCat for subscriptions, '
          'and OneSignal for push notifications.',
        ),
        LegalTerm(
    ...
    LegalSection(
      ...
      blocks: [
        LegalParagraph(
          ...
          'to provide Better Today features and is handled in accordance with the Google '
    ...
    LegalSection(
      ...
      blocks: [
        ...
        LegalBullets([
          ...
          'AES-256 encryption for personal improvement data stored in Firebase Storage.',
          'Role-based access controls and periodic security audits.',
          'Your daily improvement entries and reflections are stored in private, non-public buckets.',
        ]),
      ],
    ),
    LegalSection(
    ...
    LegalSection(
      ...
      blocks: [
        LegalParagraph(
          'Better Today is not intended for children under 13. We do not knowingly collect '
          'personal data from anyone under 13. If you believe a child has provided us with '
