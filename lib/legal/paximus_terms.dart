...
const paximusTerms = LegalDocument(
  title: 'Terms of Service for Paximus Mobile App',
  ...
  sections: [
    LegalSection(
      ...
      blocks: [
        LegalParagraph(
          'These Terms of Service (“Terms”) govern your use of the Paximus mobile '
          'application (“App”) and the website at https://foxirapps.co/paximus '
          '(“Website”) provided by Paximus Mobile App (“we,” “us,” or “our”). By '
          'accessing or using the App or Website, you (“User” or “you”) agree to be '
          'bound by these Terms. If you do not agree to these Terms, you must not use '
          'the App or Website.',
        ),
      ],
    ),
    ...
    LegalSection(
      ...
      blocks: [
        LegalParagraph(
          'Your use of the App is also governed by the Paximus Privacy Policy, which is '
    ...
    LegalSection(
      ...
      blocks: [
        LegalTerm(
          ...
          'The App offers monthly, yearly, and lifetime subscription plans.',
        ),
        LegalTerm(
          'Free Trials',
    ...
    LegalSection(
      ...
      blocks: [
        LegalParagraph(
          'You agree to indemnify and hold harmless Paximus Mobile App, its directors, '
          'officers, employees, and agents from any claims, losses, or expenses arising '
    ...
    LegalSection(
      ...
      blocks: [
        LegalParagraph(
          ...
          'between you and Foxir Apps regarding your use of Paximus.',
        ),
      ],
    ),
    LegalSection(
